...
public final class ModTooltips {
    ...
    public static final Tooltip HUD = new Tooltip("tooltip.ironjetpacks.hud");
    ...
    public static final Tooltip TOGGLE_HUD = new Tooltip("tooltip.ironjetpacks.toggle_hud");
